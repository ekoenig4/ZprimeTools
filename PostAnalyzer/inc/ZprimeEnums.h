...
enum Type {Data,Signal,ZJets,ZJets_NLO,WJets,WJets_NLO,DYJets,DYJets_NLO,QCD,TTJets,GJets,EWK,nType};
static const char * TypeName[] = {"Data","Signal","ZJets","ZJets_NLO","WJets","WJets_NLO","DYJets","DYJets_NLO","QCD","TTJets","GJets","EWK"};
