...
public:
  ...
  virtual std::vector<int> electron_veto_looseID(int jet_index,int lepindex,float elePtCut);
  virtual std::vector<int> muon_veto_looseID(int jet_index,int lepindex,float muPtCut);
