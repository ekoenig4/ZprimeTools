...
float ZprimeYear::getSF(int ele_index) {
...
void ZprimeYear::Loop(Long64_t maxEvents, int reportEvery) {
  ...
  int nTotal = 0;
  float nTotalEvents,nFilters, nHLT, nCRSelection, nMET200, pfMET50, nNoMuons, nMETcut,nbtagVeto, nDphiJetMET,nJetSelection, nEleHEM;
...
vector<int> ZprimeYear::JetVetoDecision(int jet_index, int lepindex) {
...
vector<int> ZprimeYear::muon_veto_looseID(int jet_index, int lepindex, float muPtCut)
{
