...
void ZprimeClass::BookHistos(const char* outputFilename) {
  ...
  cutflow = new Cutflow( {"Total Events","metFilters","Trigger","GoodJet","CRSelection","leptoMetCut","LeptonVeto","lepMETMt160","caloMETCut","B-JetVeto","DeltaPhiCut","eleHEMVeto"});
