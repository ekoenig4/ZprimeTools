...
void ZprimeJetsClass::BookHistos(const char* outputFilename) {
  ...
  for(int i=0; i<nHisto; i++){
    ...
    h_ChNemPtFracFirst3[i] = new TH1F(("ChNemPtFracFirst3"+histname).c_str(),"ChNemPtFracFirst3;First 3 Ch + NEM P_{T}^{123} Fraction",50,0,1.1);h_ChNemPtFracFirst3[i]->Sumw2();
    ...
    h_ChPtFracFirst3[i] = new TH1F(("ChPtFracFirst3"+histname).c_str(),"ChPtFracFirst3; First 3 Charged P_{T} Fraction",50,0,1.1);h_ChPtFracFirst3[i]->Sumw2();
    ...
    h_bChNemPtFracFirst3[i] = new TH1F(("bChNemPtFracFirst3"+histname).c_str(),"bChNemPtFracFirst3;Barrel First 3 Ch + NEM P_{T}^{123} Fraction",50,0,1.1);h_bChNemPtFracFirst3[i]->Sumw2();
    ...
    h_eChNemPtFracFirst3[i] = new TH1F(("eChNemPtFracFirst3"+histname).c_str(),"eChNemPtFracFirst3;Endcap First 3 Ch + NEM P_{T}^{123} Fraction",50,0,1.1);h_eChNemPtFracFirst3[i]->Sumw2();
...
void ZprimeJetsClass::fillHistos(int histoNumber,double event_weight) {
  ...
  if(jetCand.size()>0){
    ...
    h_ChNemPtFracFirst3[histoNumber]->Fill(ChNemPtFracFirst3,event_weight);
    
    h_ChPtFrac[histoNumber]->Fill(ChPtFrac,event_weight);
    h_ChTotPtFrac[histoNumber]->Fill(ChTotPtFrac,event_weight);
    h_ChPtFracFirst3[histoNumber]->Fill(ChPtFracFirst3,event_weight);
    ...
    if (fabs(jetEta->at(jetCand[0])) <= 1.479) {
      ...
      h_bChNemPtFracFirst3[histoNumber]->Fill(ChNemPtFracFirst3,event_weight);
      ...
      h_eChNemPtFracFirst3[histoNumber]->Fill(ChNemPtFracFirst3,event_weight);
...
void ZprimeJetsClass::getPt123Frac() {
  ...
  for (int i = 0; i < j1PFConsPID.size(); i++) {
    ...
    if (ChNemIndex < 3 && (abs(j1PFConsPID.at(i)) == 211) || abs(j1PFConsPID.at(i) == 22)) {
      ChNemFirst3 += j1PFConsPt.at(i);
      ChNemIndex++;
    }
  ...
  ChNemPtFracFirst3 = ChNemFirst3/(HadronPt[1]+HadronPt[2]);
  
  ChPtFrac = HadronPtFirst3[1]/HadronPt[1];
  ChTotPtFrac = HadronPtFirst3[1]/jetPt->at(jetCand[0]);
  ChPtFracFirst3 = HadronFirst3Frac[1]/HadronPt[1];
...
void ZprimeJetsClass::AllPFCand(vector<int> jetCand,vector<int> PFCandidates) {
  ...
  ChPtFrac=ChTotPtFrac=ChPtFracFirst3=ChNemPtFrac=ChNemPtFrac=ChNemTotPtFrac=ChNemPtFracFirst3=j1ChNemEtaWidth=0.0;
