...
public:
  ...
  virtual void BookHistos(int i,string histname) { ZprimeAnalysis::BookHistos(i,histname); };
  virtual void fillHistos(int nhist,float event_weight) { ZprimeAnalysis::fillHistos(nhist,event_weight); };
