...
public :
  ...
  ZprimeYear(const char* file1,const char* file2,const char* fileRange) : ZprimeJetsCommon(file1,file2,fileRange)
  { BookHistos(file2); };
  ...
  virtual vector<int> muon_veto_looseID(int jet_index,int leading,int subleading,float elePtCut);
