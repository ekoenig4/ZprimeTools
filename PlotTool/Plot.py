...
class datamc(object):
    ...
    def __init__(self,command=None,show=1,lumi=None,fileDir="./"):
        ...
        preRegionData = [".output/postMETdata_0_0.root",".output/postSingleEle_0_0.root",".output/postSingleMu_0_0_0.root",".output/postDoubleEle_0_0.root",".output/postDoubleMu_0_0.root"]
