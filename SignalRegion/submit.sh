...
python ../SubmitCondor.py analyze /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_2}_SR/MET/crab_dataset6/180529_*/0000/ postMETdata_0.root -1 10000 MET_0 split_1

python ../SubmitCondor.py analyze /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_2}_SR/MET/crab_dataset6/180529_*/0001/ postMETdata_1.root -1 10000 MET_1 split_1

python ../SubmitCondor.py analyze /hdfs/store/user/gomber/MonoZprime_Ntuples_${DATE_2}_SR/MET/crab_dataset6/180529_*/0002/ postMETdata_2.root -1 10000 MET_2 split_1
